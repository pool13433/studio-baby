...
<tr>
    ...
    <td style="vertical-align: text-top">
        <fieldset>
            <legend><a href="bank_form.php"><img src="image/icon/32x32-add-icon.png"/></a>จัดการธนาคาร</legend>
            <table border="1">
                <thead>
                    <tr>
                        <th>ลำดับ</th>
                    ...
                    <?php $i = 1;while ($row = mysqli_fetch_array($result)) { ?>
                        <tr>
                            ...
                            <td style="text-align: center">
                                <a href="bank_form.php?id=<?=$row['bank_id']?>">
									<img src="image/icon/32x32-edit-icon.png"/>
								</a>
                            </td>
                             <td style="text-align: center">
                                <a href="bank_delete.php?id=<?=$row['bank_id']?>" 
